      ...
      <el-table :data="rolesList" border stripe>
        ...
        <el-table-column type="expand">
            <template v-slot:default="scope">
                <el-row v-for="(item1,i1) in scope.row.children" :key="item1.id" :class="['bdbottom',i1===0? 'bdtop':0]">
                    <!-- 渲染一级权限 -->
                    <el-col :span="5">
                    ...
                    <!-- 二级三级权限 -->
                    <el-col :span="19">
                        <el-row v-for="(item2,i2) in item1.children" :key="item2.id" :class="['bdbottom',i2===0? 'bdtop':0]">
                            <el-col :span="6">
