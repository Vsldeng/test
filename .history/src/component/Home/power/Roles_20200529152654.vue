<template>
  <div class="rights">
    ...
    <el-dialog title="添加角色" :visible.sync="RolesVision" width="50%" @close="rolesClosed" @Click="handleAddRoles">
      <!-- 内容主体区域 -->
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="handleHandleAddroles">确 定</el-button>
      </span>
    </el-dialog>
  </div>
</template>
